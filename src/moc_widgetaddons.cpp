/****************************************************************************
** Meta object code from reading C++ file 'widgetaddons.h'
**
...
#error "The header file 'widgetaddons.h' doesn't include <QObject>."
